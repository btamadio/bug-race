...
* [`src/cljs/bug_race/`](src/cljs/bug_race/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/bug_race/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `bug-race` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/bug_race/config.cljs) defaults to `true` in
...
```clj
(ns bug-race.example
  (:require [bug-race.config :as config])
